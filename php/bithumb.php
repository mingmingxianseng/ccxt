...
class bithumb extends Exchange
{
    ...
    public function fetch_ticker($symbol, $params = array())
    {
        $this->load_markets();
        $market   = $this->market($symbol);
        $response = $this->publicGetTickerCurrency(
            array_merge(
                array(
                    'currency' => $market['base'],
                ), $params
    ...
    public function parse_trade($trade, $market)
    {
        ...
        $timestamp -= 9
            * 3600000; // they report UTC . 9 hours (is_array (Korean timezone) && array_key_exists (server, Korean timezone))
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array())
    {
        $this->load_markets();
        $market   = $this->market($symbol);
        $response = $this->publicGetTransactionHistoryCurrency(
            array_merge(
                array(
                    'currency' => $market['base'],
                    'count'    => 100, // max = 100
    ...
    public function cancel_order($id, $symbol = null, $params = array())
    {
        ...
        if (!$side_in_params) {
            throw new ExchangeError (
                $this->id . ' cancelOrder requires a $side parameter (sell or buy) and a $currency parameter'
            );
        }
